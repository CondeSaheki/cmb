<script lang="ts">
    ...
    // You can define any reactive variables or logic here.
    ...
    const discordLink = "https://discord.gg/guvd6fC";
</script>

<div class="flex flex-col gap-4 items-center">
    <div class="about-container">
        <div class="text-2xl">{communityDescription}</div>
    </div>
    <div>
        <a href={discordLink} class="btn btn-outline btn-ghost btn-lg">
            <svg
                width="30px"
                height="30px"
